...
*/
void MainTask(void) {
	int select=0,up=0,down=0,secondm=0,second=0,minute=0,hour=10,day=13,mouth=6,year=2016,num1=0,flag=0,add=0,d=1,x=35,y=90,i=0;
...
//*************************************************第一步绘制按钮****************************
	 ...
	 //pBitmap=&bmpicture;
     //GUI_DrawBitmap(pBitmap,10,10);//显示第一个汉字
	 //LCD_L0_FillRect(20, 160, 80, 190);//绘制第一个按钮“选择”
     //LCD_L0_FillRect(110, 160, 170, 190); //绘制第二个按钮“增加”
	 //LCD_L0_FillRect(200, 160, 260, 190);//绘制以三个按钮“减少”
...
void printCalendar(int year,int mouth,int day){
	...
	GUI_GotoXY(35+30*(DayisWeek(year,mouth,1)+2),90);
